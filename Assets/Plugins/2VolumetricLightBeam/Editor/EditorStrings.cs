...
- SRP Batcher: Use the SRP Batcher to automatically batch multiple beams and reduce draw calls. Only available when using SRP.");
            ...
            public static class HD
            {
                ...
                public static readonly GUIContent FeatureEnabledShadow          = new GUIContent("Shadow (HD only)", "Support 'Shadow' features or not.");
                public static readonly GUIContent FeatureEnabledCookie          = new GUIContent("Cookie (HD only)", "Support 'Cookie' feature or not.");
            }
        }
